...
* The original package name 'com.example.productservice.product-service-backend' is invalid and this project uses 'com.example.productservice.product_service_backend' instead.
